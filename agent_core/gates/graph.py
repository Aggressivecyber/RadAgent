...
def build_gate_validation_subgraph() -> StateGraph:
    ...
    graph.add_node("run_visual_review_gate", run_visual_review_gate)
    ...
    graph.add_edge("run_credibility_gate", "run_visual_review_gate")
    graph.add_edge("run_visual_review_gate", "finalize_gate_results")
