...
class TaskSpec(BaseModel):
    ...
    requirements_review_hints: dict[str, Any] | None = Field(
        default=None,
        description=(
            "Questions and defaults generated by planning when source or geometry "
            "parameters must be reviewed by a human before modeling."
        ),
    )
    clarification_request: dict[str, Any] | None = Field(
        default=None,
        description="Structured clarification request emitted by task planning.",
    )
    confirmed_requirement_plan: dict[str, Any] | None = Field(
        default=None,
        description=(
            "User-approved requirements review artifact carried into Geant4 "
            "modeling as hard constraints."
        ),
    )
